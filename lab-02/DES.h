...
{
public:
    bitset<64> process_block(bitset<64> value, bitset<64> key, bool decypher = false);
...
protected:
    ...
    vector<bitset<48>> generate_keys(bitset<64> key, bool decypher = false);
